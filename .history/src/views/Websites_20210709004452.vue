      ...
      <div class="content">
        <div class="part" v-for="(i, index) of datas" :key="index">
          <div class="col-sm-12 col-md-12 col-lg-12 partTitle" :id="i._id">
            <!-- <span>{{ i._id }}</span> -->
            <!-- <span v-show="!show.edit.status_2[i.flag] || show.edit.status_2[i.flag] == false">{{ i._id }}</span>
            <el-input v-show="show.edit.status_2[i.flag] && show.edit.status_2[i.flag] == true" :key="i.flag"></el-input> -->
            <template v-if="!show.edit.status_2[i.flag] || show.edit.status_2[i.flag] == false">
              <span>{{ i._id }}</span>
            </template>
            <template v-else>      <el-input :key="i.flag"></el-input>  </template>
                   
