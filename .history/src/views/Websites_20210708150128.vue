        ...
        <div class="part" v-for="(i, index) of datas" :key="index">
          <div class="col-sm-12 col-md-12 col-lg-12 partTitle" :id="i._id">
            ...
            <div class="action">
              ...
              <i class="iconfont icon-edit2" @click="click_showEdit({ flag: i.flag })" v-if="!show.edit.status_1[i.flag]"></i>
          ...
          <div class="col-sm-6 col-md-4 col-lg-3 partContent" v-for="j of i.children" :key="j._id">
            <div class="info">
              ...
              <div class="two">
                <i class="iconfont icon-edit1" @click="click_edit({ index: index, j: j })" v-show="show.edit.status_2[j.flag]"></i>
