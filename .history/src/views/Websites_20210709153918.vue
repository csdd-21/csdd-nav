      ...
      <div class="content">
        <div class="part" v-for="(i, index) of datas" :key="index">
          <div class="col-sm-12 col-md-12 col-lg-12 partTitle" :id="i._id">
            ...
            <template v-else><el-input v-model='parent' :key="i.flag"></el-input></template>
            <div class="action">
              <span class="add" @click="click_showAdd({ index: index, flag: i.flag, parent: i.parent })">+</span>
              <i class="iconfont icon-edit2" @click="click_showEdit(i.flag,i.parent)" v-if="!show.edit[i.flag]"></i>
