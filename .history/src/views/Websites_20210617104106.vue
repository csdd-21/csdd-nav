      ...
      <div class="content">
        <div class="part" v-for="(i, index) of datas" :key="index">
          <div class="col-sm-12 col-md-12 col-lg-12 partTitle" :id="i._id">
            <span>{{ i._id }}</span>
            <div class="action">
              <el-tooltip class="item" effect="dark" content="新增数据" placement="top-end">
                <!-- <span class="add" @click="clickAdd({ id: i._id, flag: i.flag, parent: i.parent })">+</span> -->
                <i class="iconfont icon-edit2" @click="click_showEdit"></i>
              </el-tooltip>
              <el-tooltip class="item" effect="dark" content="编辑数据" placement="top-end">
                <i class="iconfont icon-edit2" @click="click_showEdit"></i>
              </el-tooltip>
            </div>
          </div>
