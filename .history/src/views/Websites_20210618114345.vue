<template>
  <div :class="className">
    <div class="websites">
      <div class="content">
        <div class="test" :style="{backgroundImage:'url('+ url +')',backgroundSize:cover }" ></div>
        <div class="part" v-for="(i, index) of datas" :key="index">
          ...
          <div class="col-sm-6 col-md-4 col-lg-3 partContent" v-for="j of i.children" :key="j._id">
            <div class="info">
              <div class="one">
                <img :src="j.icon" />
                <div class="test" :style="{backgroundImage:'url('+ j.icon +')',backgroundSize:cover }" ></div>
                <div class="url">
