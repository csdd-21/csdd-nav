        ...
        <div class="part" v-for="(i, index) of datas" :key="index">
          <div class="col-sm-12 col-md-12 col-lg-12 partTitle" :id="i._id">
            ...
            <div class="action">
              ...
              <i class="iconfont icon-edit2" @click="click_showEdit(i.flag);show.editStatu=true" v-if='!show.editStatus'></i>
              <i class="iconfont icon-bianji" @click="click_showEdit(i.flag);show.editStatu=false" v-if='show.editStatus'></i>
            </div>
          </div>
