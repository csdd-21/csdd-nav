          ...
          <div class="col-sm-6 col-md-4 col-lg-3 partContent" v-for="j of i.children" :key="j._id">
            <div class="info">
              ...
              <div class="two">
                ...
                <i class="iconfont icon-cuo" @click="click_delete(j._id)" v-show="show.edit.status_2[j.flag]"></i>
              </div>
            </div>
          </div>
        </div>
        <Add v-if="show.add" :showAdd="show.add" :info="info" @close_showAdd="close_showAdd" :key="new Date().getMinutes + '_' +new Date().getSeconds" />
      </div>
