        ...
        <div class="part" v-for="(i, index) of datas" :key="index">
          ...
          <div class="col-sm-6 col-md-4 col-lg-3 partContent" v-for="j of i.children" :key="j._id">
            <div class="info">
              ...
              <div class="two">
                <i class="iconfont icon-edit1" @click="click_edit(index, j)" v-if="show.edit.status_2[j.flag]"></i>
                <i class="iconfont icon-cuo" @click="click_delete(index, j)" v-if="show.edit.status_2[j.flag]"></i>
              </div>
            </div>
          </div>
        </div>
