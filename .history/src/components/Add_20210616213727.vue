...
export default {
  ...
  methods: {
    ...
    clickSubmit() {
      ...
      this.axios
        .post("/api/submit", { title:this.form.title,,url: "C://Users//86138//Desktop//csdd-nav//src//assets//test//54.png" })
        .then((res) => {
    ...
    handleSuccess(file,fileLists) {
      console.log("success {file, fileLists} ---", file,fileLists);
      if (file.status ==200){
 this.form.favicon = file.url
      }
