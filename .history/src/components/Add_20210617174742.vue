    ...
    <el-dialog :title="info.parent" v-model="showAdd" :before-close="handle_close">
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="图标" prop="favicon">
          <img src="../../server/tmp_uploads/3dcec9d04af00a67fb8820fbc92740cf.png" alt="img">
          <el-upload action="/api/upload" :file-list="fileList" :before-upload="handle_before" :on-change="handle_change" :on-success="handle_success" v-model="form.favicon" list-type="text">
            <el-button size="small" type="primary" v-show="fileList.length == 0">点击上传</el-button>
            <el-button size="small" type="primary" v-show="fileList.length != 0">重新上传</el-button>
            <template #tip>
  ...
  methods: {
    ...
    handle_success(res, file) {
      ...
      if (res.status == 200) {
        ...
        this.form.iconPath = '../../server/tmp_uploads/3dcec9d04af00a67fb8820fbc92740cf.png'
      }
    },
