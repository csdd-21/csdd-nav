  ...
  <div class="add">
    <el-dialog :title="info.id" v-model="showAdd" :modal-append-to-body="false">
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="图标"  v-model="form.favicon">
          <el-upload prop="favicon" action="/api/upload" :data="{ title: 111 }" :limit="1" :on-success="handleSuccess" list-type="picture">
...
export default {
  ...
  methods: {
    ...
    clickSure() {
      ...
      this.axios
        .post("/api/submit", { url: 'C://Users//86138//Desktop//csdd-nav//src//assets//test//54.png' })
        .then((res) => {
