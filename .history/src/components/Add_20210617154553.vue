    ...
    <el-dialog :title="info.parent" v-model="showAdd" :before-close="handle_close">
      ...
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="图标" prop="favicon">
          <el-upload class="upload-demo" action="/api/upload" :limit="1" :on-change="handleChange" :on-success="handleSuccess" list-type="picture" v-model="form.favicon">
            <el-button size="small" type="primary">点击上传</el-button>
          </el-upload>
        </el-form-item>
      </el-form>
...
export default {
  ...
  mounted() {
    ...
    console.log('8888',document.getElementById('upload'));
