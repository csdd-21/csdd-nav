...
app.post("/edit", function (req, res) {
    ...
    console.log('1111',req.body.icon.split('/'));
    console.log('22222',req.body.icon.split('\\'));
    if (req.body.icon.split('/')) {
        console.log('edit 000000000000000-----------');
    } else {
        console.log('edit 1111111111111111111111-----------');
    }
    if (req.body.icon.split('\\')) {
        console.log('edit 2222222222222222-----------');
    }
    // if (!req.body.title || + !req.body.url || !req.body.icon) {
    //     return res.send({ status: 412, message: "参数不能为空" })
    // }
